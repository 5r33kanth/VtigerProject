...
public class GenericUtilities {
	...
	public void cilckAndHoldElement(WebDriver driver, WebElement element) {
	...
	public void pressKey(int keyCode) {
		...
		try {
			...
			System.out.println("Unablle to press the key");
	...
	public void checkTheCheckBoxUsingJSE(WebDriver driver, String id) {
		JavascriptExecutor js =(JavascriptExecutor) driver;
		js.executeScript("document.getElementById('"+id+"').checked=true");
	...
	public String currentDate() {
		...
		return new Date().toString().toString().replaceAll(":", "_").replaceAll(" ", "_");
	...
	public String captureScreenShot(WebDriver driver, String path) {
		//void-->string
		File dst;                   //changes strung path file dst
		try {
			
			TakesScreenshot ts = (TakesScreenshot) driver;
			
			File src = ts.getScreenshotAs(OutputType.FILE);
//			File dst = new File("C:\\Testing\\Vtiger\\src\\test\\resources\\defectimages\\defect_Vtiger_"+currentDate()+".jpg");
			dst = new File(path);
			Files.copy(src, dst);
