...
//	WebDriver driver;  ---**Not used because when driver is declared as global variable, the value of driver will be null
	//so we need to get the url from main in passUrl method

	public WebDriver launchBrowser(String browser) {  //removed string browser in parameter
